...
class HybridNIDS:
    ...
    # Update handle_alert method in HybridNIDS
    def handle_alert(self, alert_data):
        ...
        try:
            ...
            # Calculate detection latency if timestamps are available
            ...
            if alert_handling_time > 0.1:  # More than 100ms is concerning
                ...
                logger.debug(f"Alert handled in {alert_handling_time:.3f}s")
